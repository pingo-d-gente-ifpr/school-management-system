<x-app-layout>
    <div class="container">
        <div class="container pt-5 pb-3 page-title">
            <h1 class="m-3">Matérias</h1>
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><div class="d-flex justify-content-end">
                        <button data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" class="btn btn-success text-uppercase">Nova matéria</button>
                    </div></th>
                </tr>
            </thead>
            <tbody>
          ...
          <form method="POST" enctype="multipart/form-data" action="{{route('subjects.store')}}">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input class="form-control" placeholder="Selecione um horário" id="start_date" name="start_date"/>
              </div>
              <div class="col-md-6 mb-3">
                <label for="end_date" class="form-label">Horário de Término</label>
                <input class="form-control" placeholder="Selecione um horário" id="end_date" name="end_date"/>
              </div>
            </div>
            <div class="mb-3">
              <div class="row align-items-start">
                <x-input-label for="photo" class="form-label col-sm-2 col-lg-2">Foto:</x-input-label>
                <input class="form-control form-control-sm col-sm-10 col-lg-10" id="photo" type="file" name="photo">
              </div>
            </div>
