...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="public/build/assets/app-81c1b68b.css">
        ...
        <!-- Scripts -->
        @vite(['public/build/assets/app-81c1b68b.css', 'public/build/assets/app-6e0eadfb.js'])
    </head>
